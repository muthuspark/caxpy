...
public class BiUtilityTest extends TestCase {
	...
	public void testSave() {
		...
		try {
			...
			//save first
			String savedReportName = BiUtility.saveReport(reportdata);
			assertTrue(BiUtility.isValidReportName(savedReportName));
			String report = BiUtility.getReport(savedReportName);
			
			//save second
			String repname1 = BiUtility.saveReport(report);
			assertEquals(savedReportName, repname1);
			//save third
			String repname2 = BiUtility.saveReport(report);
			assertEquals(savedReportName, repname2);
			
			//save fourth
			String repname3 = BiUtility.saveReport(report);
	...
	public void testSaveAs() {
		...
		try {
			...
			String saveReport = BiUtility.saveReport(reportdata);
	...
	public void testDelete() {
		...
		String saveReport = BiUtility.saveReport(reportdata3);
	...
	public void testGetreportjson() throws JSONException{
		...
		String savedReportName = BiUtility.saveReport(report);
	...
	public void testGetReportJSONWithParameters(){
		...
		assertEquals("{\"chartData\":[{\"sum(store_sales)\":\"1.0800\",\"customer_id\":5},{\"sum(store_sales)\":\"38.7000\",\"customer_id\":10},{\"sum(store_sales)\":\"24.8600\",\"customer_id\":20},{\"sum(store_sales)\":\"4.6000\",\"customer_id\":21},{\"sum(store_sales)\":\"28.4600\",\"customer_id\":23},{\"sum(store_sales)\":\"33.5300\",\"customer_id\":28},{\"sum(store_sales)\":\"28.7600\",\"customer_id\":30},{\"sum(store_sales)\":\"8.4300\",\"customer_id\":39},{\"sum(store_sales)\":\"46.0100\",\"customer_id\":41},{\"sum(store_sales)\":\"31.9900\",\"customer_id\":43},{\"sum(store_sales)\":\"41.8100\",\"customer_id\":45},{\"sum(store_sales)\":\"17.7600\",\"customer_id\":49},{\"sum(store_sales)\":\"31.1100\",\"customer_id\":55},{\"sum(store_sales)\":\"47.4600\",\"customer_id\":64},{\"sum(store_sales)\":\"18.0300\",\"customer_id\":74},{\"sum(store_sales)\":\"83.6200\",\"customer_id\":76},{\"sum(store_sales)\":\"47.0300\",\"customer_id\":77},{\"sum(store_sales)\":\"29.3300\",\"customer_id\":79},{\"sum(store_sales)\":\"46.8600\",\"customer_id\":80},{\"sum(store_sales)\":\"17.9400\",\"customer_id\":81}],\"connection\":\"mysql-foodmart\",\"chartProperties\":{\"xtitle\":\"Customers\",\"cache\":\"\",\"chartTitle\":\"\",\"chartSubTitle\":\"\",\"ytitle\":\"Sum of Store Sales\"},\"query_colums\":[\"customer_id\",\"sum(store_sales)\"],\"query\":\"select customer_id, sum(store_sales) from agg_lc_100_sales_fact_1997 where quarter='<q>' group by customer_id limit 20\",\"rawData\":[],\"charttype\":\"column_chart\",\"chart_rows\":[\"sum(store_sales)\"],\"realtime\":false,\"charttitle\":null,\"report_name\":\""+reportId+"-quater test\",\"report_id\":"+reportId+",\"query_params\":[{\"name\":\"q\",\"value\":\"Q1\"}],\"chart_cols\":[\"customer_id\"]}",reportJson1);
		assertEquals("{\"chartData\":[{\"sum(store_sales)\":\"33.4800\",\"customer_id\":3},{\"sum(store_sales)\":\"32.6000\",\"customer_id\":20},{\"sum(store_sales)\":\"1.4600\",\"customer_id\":28},{\"sum(store_sales)\":\"29.0400\",\"customer_id\":30},{\"sum(store_sales)\":\"17.1200\",\"customer_id\":36},{\"sum(store_sales)\":\"25.5900\",\"customer_id\":39},{\"sum(store_sales)\":\"21.8600\",\"customer_id\":40},{\"sum(store_sales)\":\"57.9600\",\"customer_id\":44},{\"sum(store_sales)\":\"39.3900\",\"customer_id\":45},{\"sum(store_sales)\":\"19.0500\",\"customer_id\":49},{\"sum(store_sales)\":\"22.7900\",\"customer_id\":55},{\"sum(store_sales)\":\"17.9100\",\"customer_id\":76},{\"sum(store_sales)\":\"44.8700\",\"customer_id\":79},{\"sum(store_sales)\":\"35.2400\",\"customer_id\":88},{\"sum(store_sales)\":\"7.3600\",\"customer_id\":91},{\"sum(store_sales)\":\"138.2500\",\"customer_id\":99},{\"sum(store_sales)\":\"15.3000\",\"customer_id\":105},{\"sum(store_sales)\":\"36.0600\",\"customer_id\":112},{\"sum(store_sales)\":\"29.0800\",\"customer_id\":115},{\"sum(store_sales)\":\"42.1200\",\"customer_id\":118}],\"connection\":\"mysql-foodmart\",\"chartProperties\":{\"xtitle\":\"Customers\",\"cache\":\"\",\"chartTitle\":\"\",\"chartSubTitle\":\"\",\"ytitle\":\"Sum of Store Sales\"},\"query_colums\":[\"customer_id\",\"sum(store_sales)\"],\"query\":\"select customer_id, sum(store_sales) from agg_lc_100_sales_fact_1997 where quarter='<q>' group by customer_id limit 20\",\"rawData\":[],\"charttype\":\"column_chart\",\"chart_rows\":[\"sum(store_sales)\"],\"realtime\":false,\"charttitle\":null,\"report_name\":\""+reportId+"-quater test\",\"report_id\":"+reportId+",\"query_params\":[{\"name\":\"q\",\"value\":\"Q1\"}],\"chart_cols\":[\"customer_id\"]}",reportJson2);
	}
